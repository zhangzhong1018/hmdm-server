...
document.localization['zh_CN'] = {
    ...
    'form.settings.servers.title': '域名服务',
    'form.settings.servers.broadcast': '视频服务域名',
    'form.settings.servers.broadcast.placeholder': '请输入视频服务域名',
    'form.settings.servers.meeting': '会议服务域名',
    'form.settings.servers.meeting.placeholder': '请输入会议服务域名',
    'success.settings.servers.saved':"服务域名已成功储存",
    'breadcrumb.servers': '服务',

    'breadcrumb.broadcasts': '视频',
    'form.settings.broadcasts.title': '视频会议',
    'form.settings.broadcasts.search.placeholder': '视频会议查询',
    'table.heading.broadcasts.actions': '功能',
    'table.heading.broadcasts.type': '类型',
    'table.heading.broadcasts.number': '会议ID',
    'table.heading.broadcasts.subject': '主题',
    'table.heading.broadcasts.description': '描叙',
    'table.heading.broadcasts.startTime': '开始时间',
    ...
    'form.broadcast.subject': '主题',
    'form.broadcast.description': '描叙',
    'form.broadcast.startTime': '开始时间',
    'form.broadcast.lecturer': '主讲人',
    'form.broadcast.attendees': '参会人员',
    'form.broadcast.devices': '设备',
    'form.broadcast.type.option.broadcast': '视频',
    'form.broadcast.type.option.meeting': '会议',
    'table.filtering.no.selected.device': '未选择设备',
    'table.filtering.suffix.device': '设备',
    'error.empty.broadcast.name': '填写视频会议ID',
